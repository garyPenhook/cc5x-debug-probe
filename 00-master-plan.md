...
zero warnings; P5a VCP 2336 B flash / 2152 B RAM, P5b USB-CDC 4572 B flash / 2240 B
...
- Probe firmware: `cc5x-debug-probe/firmware/probe-f042/` (P5). Direct-register LL
  ...
  (P5a VCP 2336 B flash / 2152 B RAM; P5b USB-CDC 4572 B flash / 2240 B of 6 KB RAM),
